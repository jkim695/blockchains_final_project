...
\def\@maketitle{\newpage \null
 ...
 \begin{center}\large\bf\lineskip .75em
 \begin{tabular}[t]{c}\bf\@author \end{tabular}\par
 \end{center}\par\vskip 0.7em}
\renewenvironment{abstract}%
  {\centerline{\large\bf Abstract}%
   \begin{list}{}{\setlength{\rightmargin}{0.6cm}\setlength{\leftmargin}{0.6cm}}\item[]\ignorespaces}%
  {\unskip\end{list}}
